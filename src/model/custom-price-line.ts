...
import { CustomPriceLinePriceAxisLabelView } from '../views/price-axis/custom-price-line-price-axis-label-view';
...
export class CustomPriceLine {
	...
	private readonly _priceAxisView: CustomPriceLinePriceAxisLabelView;
	private readonly _panePriceAxisView: PanePriceAxisLabelView;
	...
	public constructor(series: Series, options: PriceLineOptions) {
		...
		this._priceAxisView = new CustomPriceLinePriceAxisLabelView(series, this);
		this._panePriceAxisView = new PanePriceAxisLabelView(this._priceAxisView, series, series.model());
	}
